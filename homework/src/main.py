...
import os
import pathlib  # <--- AGREGADO: Para manejar rutas de Windows correctamente
import uuid
...
def main():
    ...
    # Configurar MLflow para usar ruta absoluta compatible con Windows
    # Usamos .as_uri() para que transforme "C:\..." en "file:///C:/..." automáticamente
    tracking_uri = pathlib.Path(os.getcwd()).joinpath("mlruns").as_uri()
